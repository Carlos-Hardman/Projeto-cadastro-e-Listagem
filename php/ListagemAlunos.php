...
$sql = "SELECT * FROM Alunos LIMIT :limite OFFSET :offset";
    ...
    <main>
        <div class="conteinerOperacao">
            ...
            <div class="DivListagem">
                ...
                <a href="#" class="ListagemAlunos">Listagem de Alunos</a>
            </div>
                ...
                <tbody>
                    ...
                    foreach ($alunos as $aluno) {
                        echo "<tr>
                            ...
                            <td>{$aluno['NomeAlunos']}</td>
                            <td>{$aluno['TelefoneAluno']}</td>
                            <td>{$aluno['IdadeAluno']}</td>
                            <td>{$aluno['HoraAula']}</td>
                            <td>{$aluno['ProfessorAula']}</td>
                            <td>{$aluno['ModalidadeAula']}</td>
                        </tr>";
                    }
                    ?>
                </tbody>
